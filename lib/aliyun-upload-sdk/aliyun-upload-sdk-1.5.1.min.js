!function (e) {
    ...
    r = [], void 0 !== (o = function () {
        return s
    }.apply(t, r)) && (e.exports = o), window.AliyunUpload = s
}, function (e, t, n) {
    "use strict";
    ...
    var i = function () {
        ...
        E = (n(2), function () {
            function e(t) {
                o(this, e), this.options = t, this.options.partSize = this.options.partSize || s.UPLOADDEFAULT.PARTSIZE, this.options.parallel = this.options.parallel || s.UPLOADDEFAULT.PARALLEL, this.options.region = this.options.region || "cn-shanghai", this.options.cname = this.options.cname || !1, this.options.localCheckpoint = this.options.localCheckpoint || !1, void 0 === this.options.enableUploadProgress && (this.options.enableUploadProgress = !0), this._ossCreditor = new Object, this._state = a.VODSTATE.INIT, this._uploadList = [], this._curIndex = -1, this._ossUpload = null, this._log = new g.default, this._retryCount = 0, this._retryTotal = this.options.retryCount || 3, this._retryDuration = this.options.retryDuration || 2, this._state = a.VODSTATE.INIT, this._uploadWay = "vod", this._onbeforeunload = !1, this._invalidUserId = !1, this._initEvent()
            }
            ...
            return i(e, [{
                ...
                key: "addFile", value: function (e, t, n, r, o, i) {
                    ...
                    var u = new Object;
                    if (u.file = e, u._endpoint = t, u._bucket = n, u._object = r, u.state = a.UPLOADSTATE.INIT, u.isImage = y.default.isImage(e.name), !u.isImage && this.options.enableUploadProgress) {
                        var c = this;
                        I.default.getMd5(e, function (e) {
                            u.fileHash = e;
                            var t = c._getCheckoutpoint(u);
                            c.options.localCheckpoint || t || c._getCheckoutpointFromCloud(u, function (e) {
                                if (e.UploadPoint) {
                    ...
                    o && (u.videoInfo = o ? JSON.parse(o).Vod : {}, u.userData = f.default.encode(o)), u.ri = m.default.create(), this._uploadList.push(u), this._reportLog("20001", u, {ql: this._uploadList.length});
                    try {
                ...
                key: "setSTSToken", value: function (e, t, n, r) {
                    ...
                    o.ImageType && (i.imageType = o.ImageType), o.ImageExt && (i.imageExt = o.ImageExt), o.FileSize && (i.fileSize = o.FileSize), o.Description && (i.description = o.Description), o.CateId && (i.cateId = o.CateId), o.Tags && (i.tags = o.Tags), o.TemplateGroupId && (i.templateGroupId = o.TemplateGroupId), o.StorageLocation && (i.storageLocation = o.StorageLocation), o.CoverURL && (i.coverUrl = o.CoverURL), o.TransCodeMode && (i.transCodeMode = o.TransCodeMode), o.UserData && (i.userData = o.UserData);
    ...
    var i = function () {
        ...
        return i(e, null, [{
            ...
            key: "getUploadAuth", value: function (e, t, n) {
                ...
                e.fileSize && (o.FileSize = e.fileSize), e.description && (o.Description = e.description), e.cateId && (o.CateId = e.cateId), e.tags && (o.Tags = e.tags), e.templateGroupId && (o.TemplateGroupId = e.templateGroupId), e.storageLocation && (o.StorageLocation = e.storageLocation), e.coverUrl && (o.CoverURL = e.coverUrl), e.transCodeMode && (o.TransCodeMode = e.transCodeMode), e.userData && (o.UserData = JSON.stringify(e.userData));
        ...
        return o(e, null, [{
            key: "getMd5", value: function (e, t, n) {
                ...
                r.onload = function (e) {
                    try {
                        if (e && e.target) {
                            var n = i(a.parse(e.target.result)), r = n.toString();
                            t(r)
                        }
                    } catch (e) {
                        console.log(e)
